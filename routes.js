...
router.get('/user', checkJwt, cors(corsOptions), (req, res) => userController.getUserController(req, res))
router.put('/update-group', checkJwt, cors(corsOptions), (req, res) => userController.updateGroupController(req, res))
router.get('/score-board/:status', checkJwt, cors(corsOptions), (req, res) => userController.getScoreBoardController(req, res))
router.delete('/del-user', checkJwt, cors(corsOptions), (req, res) => userController.deleteUserController(req, res))
router.delete('/check-updated', checkJwt, cors(corsOptions), (req, res) => userController.checkUpdatedController(req, res))
router.post('/destroy-token', checkJwt, cors(corsOptions), (req, res) => userController.destroyTokenController(req, res))
...
router.get('/question-id/:userId/:questionId', checkJwt, cors(corsOptions), (req, res) => questionController.getQuestionByIdController(req, res))
router.get('/all-questions', checkJwt, cors(corsOptions), (req, res) => questionController.getQuestionController(req, res))
...
router.get('/sub-code', checkJwt, cors(corsOptions), (req, res) => submissionController.getSubmissionCodeController(req, res))
router.get('/finish-sub', checkJwt, cors(corsOptions), (req, res) => submissionController.getFinishSubmissionCodeController(req, res))
router.get('/submission', checkJwt, cors(corsOptions), (req, res) => submissionController.getSubmissionController(req, res))
